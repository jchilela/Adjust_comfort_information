...
function submit(){
  ...
  $(function(){
    ...
    $.ajax({
      type: "POST",
      url: 'http://localhost/insert_aci.php',
      data: ({idade: idade, gender: gender, weight: weight, atime: atime, dtime: dtime, tcomfort: tcomfort,acept: acept, pref: pref,sens: sens,  }),
...
function msg(){
    document.getElementById('msg').value="To edit before submit, click in the number"
}
function clearmsg(){
